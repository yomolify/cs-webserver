...
var _styleAnimations = require('../style/animations');

var _styleAnimations2 = _interopRequireDefault(_styleAnimations);
...
function updateStyling() {
  var styles = (0, _utilsHelpers.mapObject)(styleStorage, function (storageEntry, id) {
  ...
  if (styleElement) {
    styleElement.innerHTML = (0, _utilsHelpers.flatten)([_styleAnimations2['default'], styles]).join(' ');
  }
}
