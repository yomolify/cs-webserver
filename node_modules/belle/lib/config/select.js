...
var findIndexOfSelectedOption = function findIndexOfSelectedOption(component) {
  var filterFunction = function filterFunction(child) {
    return (0, _utilsIsComponentOfTypeJs2['default'])('Belle Option', child) || (0, _utilsIsComponentOfTypeJs2['default'])('Belle Separator', child);
  };
...
var selectConfig = {
  ...
  positionOptions: function positionOptions(selectComponent) {
    ...
    var selectedOptionWrapperNode = _react2['default'].findDOMNode(selectComponent.refs.selectedOptionWrapper);
